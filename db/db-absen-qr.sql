...
(1, 'admin.fikom@ustj.ac.id', '$2y$10$WZ9v2C14y/nBcbw1vjsGwOKtTDCRiXyJrFSgJqC8wXNmx24/Q3cpe', '1'),
(2, 'dosen1', '$2y$10$ZlsKwYGCd0PhFqdwSmrmmeBjb2n9itpHahwkbW.pS5xPNXiNipChO', '2'),
(4, '18411064', '$2y$10$VautlBlMQGB0w56Mm1eRe.NGmSR9DVQ.wHLWmRaz.5AGJ72eGBIYi', '3'),
(5, '202020', '$2y$10$0c.jmFfpiTSOO2hI2wCmd.ap6LQEUCbnSbHUiNX2nmt.LnCiornmi', '2');
...
INSERT INTO `tbl_dt_absen` (`id_absen`, `npm`, `id_jadwal`, `status`) VALUES
(1, '18411064', '3201', '1'),
(2, '18411064', '2', '1'),
(4, '', '', '1'),
(5, '1', '1', '1');
...
INSERT INTO `tbl_dt_dosen` (`nidn`, `nama_dosen`, `tempat_lahir`, `tgl_lahir`, `jk`, `email`) VALUES
('1234567', 'Pri Utomo Damar Agung, S.Kom', 'Sentani', '2000-03-10', 'Laki', 'massagung52@gmail.comm'),
('124322', 'Ziko Salasa, S.Kom', 'Jayapura', '1999-10-22', 'Laki-laki', 'ziko@gmail.com'),
('18192021', 'Dilif Makalalag, S.Kom', 'Maelang', '2000-12-12', 'a', 'alsptraw12@gmail.com'),
('202020', 'Arnol Pongmasangka', 'JAYAPURA', '2000-01-01', 'LAKI-LAKI', 'anno@gmail.com');
...
INSERT INTO `tbl_dt_jadwal` (`id_jadwal`, `kode_mk`, `nidn`, `jam`, `ruangan`, `kelas`) VALUES
(1, 120101, 22222, '0000-00-00', 'H1', 'A');
...
INSERT INTO `tbl_dt_matkul` (`kode_mk`, `nidn`, `mata_kuliah`, `sks`) VALUES
('120101', '18192021', 'Logika dan Algoritma', 5);
...
INSERT INTO `tbl_dt_mhs` (`npm`, `nama_mhs`, `tempat_lahir`, `tgl_lahir`, `jk`, `email`) VALUES
('18411064', 'DILIF MAKALALAG', 'MAELANG', '2000-05-28', 'LAKI-LAKI', 'dilif.makalalag@gmail.com');
...
(1, 'Tata Usaha', 'ustj@gmail.ac.id', 'abc', 1);
