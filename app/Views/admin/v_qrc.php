   ...
   <div class="w-full mt-2">
      ...
      foreach ($qrc as $key => $value) { ?>
               <tr>
                  ...
                  <td>
                     <ul>
                        <li>Kelas : <?php echo $value['kelas']; ?></li>
                        <li>Kode Mata Kuliah : <?php echo $value['kode_mk']; ?></li>
                        <li>Mata Kuliah : <?php echo $value['mata_kuliah']; ?></li>
                  ...
                  <td>
                     <div class="flex justify-center gap-4 px-4">
                        <a href="<?php echo base_url('Admin/downloadQRC/'.$value['id_jadwal']); ?>"
                           onclick="return confirm('Apakah Data Ini Akan Dihapus ?')"
                           class="border border-red-500 rounded-lg px-2 py-1 hover:bg-red-500 hover:text-white">Download</a>
                     </div>
                  </td>
               </tr>
               <?php } ?>
